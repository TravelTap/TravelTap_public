  ...
  return (
    <div className="relative w-[360px] h-[932px] bg-[#fff]">
      ...
      <div className="absolute -translate-x-1/2 left-1/2 top-[96px] w-[294px] h-[784px]">
        <div className="absolute left-0 top-0 w-[294px] h-[222px] flex">
          ...
          <img
            className="absolute left-[266px] top-[118px]"
            width="23"
            height="36"
            src="./img/Main/Component 16_35.png"
          ></img>
          <img
            className="absolute left-[4px] top-[118px]"
            width="23"
            height="36"
        ...
        <div className="absolute left-0 top-[282px] w-[293px] h-[194px] flex">
          ...
          ></img>
          <img
            className="absolute left-[264px] top-[116px]"
            width="22"
            height="36"
            src="./img/Main/Component 36_52.png"
          ></img>
          <img
            className="absolute left-[4px] top-[116px]"
            width="22"
            height="36"
        ...
        <div className="absolute left-0 top-[538px] w-[293px] h-[246px] flex">
          <img
            className="absolute left-0 top-[65px]"
            width="293"
            height="181"
